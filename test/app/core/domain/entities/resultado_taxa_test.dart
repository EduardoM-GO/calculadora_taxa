...
void main() {
  test('resultado taxa - get valor taxa - valor positivo', () async {
    const result = ResultadoTaxa(valorRecebido: 100, valorCobrado: 120.50);
    expect(result.valorTaxa, 20.50);
  });
  test('resultado taxa - get valor taxa - valor negativo', () async {
    const result = ResultadoTaxa(valorRecebido: 120.50, valorCobrado: 100);
    expect(result.valorTaxa, -20.50);
  });

  test('resultado taxa - get valor taxa - valor zerado', () async {
    const result = ResultadoTaxa(valorRecebido: 0, valorCobrado: 0);
    expect(result.valorTaxa, 0);
    const result2 = ResultadoTaxa(valorRecebido: 100, valorCobrado: 100);
